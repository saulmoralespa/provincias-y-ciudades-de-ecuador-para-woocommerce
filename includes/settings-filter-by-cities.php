...
$settings =  array(
    'single_method' => array(
        'title' 		=> __( 'Single method', 'provincias-y-ciudades-de-ecuador-para-woocommerce' ),
        'type' 			=> 'select',
        'description' 	=> __( 'When doing single shipping method, it eliminates all others and imposes its own rules', 'provincias-y-ciudades-de-ecuador-para-woocommerce' ),
    ...
    'cost' => array(
        'title' => __('Coste', 'provincias-y-ciudades-de-ecuador-para-woocommerce'),
        'type' 			=> 'text',
    ...
    'cities' => array(
        'title' => __('Cities','provincias-y-ciudades-de-ecuador-para-woocommerce'),
        'type' => 'multiselect',
        'class'       => 'wc-enhanced-select',
        'description' => __( 'Select the city referring to the region that you have previously added', 'provincias-y-ciudades-de-ecuador-para-woocommerce' ),
        'options' => $this->showCitiesRegions(),
        'desc_tip'    => true,
    ),
    'rules' => array(
        'title'       => __( 'Reglas de cálculo', 'provincias-y-ciudades-de-ecuador-para-woocommerce' ),
        'type'        => 'rules_shipping'
    )
);
